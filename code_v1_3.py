...
train_clean_dir = '/content/drive/MyDrive/dl_project/train_HR' # Path to source images
train_blur_dir = '/content/drive/MyDrive/dl_project/train_LR'   # Path to target images
