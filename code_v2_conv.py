# -*- coding: utf-8 -*-
"""Untitled3_(1)_(1).ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1Nrs69QMtIUddYawBiQ1TcZG7xUYgg1h8
"""
...
#         Act = functools.partial(Act)
    ...
    def forward(self, x,y):
        ...
        V_p = self.get_param(y2)

        output= torch.einsum("abcde,abf->bfde", (V_p, h2_theta.permute(2,0,1)))
        return output+y
...
for epoch in range(0, n_epochs):
    ...
    if (epoch+1)%5==0:
      model.eval()
      val_loss,ISSM=model.val_loss(dataloaderVal,device)
      model.train()
